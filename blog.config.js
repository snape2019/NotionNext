...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://n.lmkiki.top', // 网站地址
  ...
  POST_PREVIEW_LINES: process.env.NEXT_PUBLIC_POST_POST_PREVIEW_LINES || 7, // 预览博客行数
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '冷面的博客', // 站点描述，被notion中的页面描述覆盖
